...
export interface UploadProps {
    ...
    defaultFileList?: UploadFile[]; //上传的文件列表
    beforeUpload?: (file: File) => boolean | Promise<File>; // 上传文件之前的钩子，参数为上传文件
...
export const Upload: FC<UploadProps> = (props) => {
    ...
    return (
        <div className='ce-upload-component'>
            <div className='ce-upload-input' style={{ display: 'inline-block' }} onClick={handleClick} >
